                    ...
                    <form action="?" method="post" name="fm01">
                      <tr>
                        <td align="left"><FIELDSET style="margin:5px; padding:5px;">
                          ...
                          <input name="" type="button" value="返回调查页" onclick="javascript:location.href='research.asp?ID=<%=ID%>';"/>
                          </span>
                          </FIELDSET></td>
                      </tr>
                      <tr>
                            ...
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
								...
								%>
                                  ...
                                  <%
								    Next
								  Else                        ' iImage="Select" Then
								  
								  kk = kk +1                  ' 第几个字段
								  For jj=Page To Page+PSize-1 ' 第几条记录
								   'If Int(Page) <= Int(shRec) Then '///////////////////////////////////////// 
								   If jj-1 < Int(shRec) Then 
								%>
                                  <FIELDSET style="margin:1px; padding:1px; padding-top:0; margin-top:0;">
                                  <%
								      s9 = aLogs(0,jj-1)
									  sa = Split(s9,";")
									  s0 = Show_Text(sa(kk-1))
									  jMax = jj
								   %>
                                  <LEGEND align="left" style="display:block"> <span class="fnt00F">&middot;观点<%=jj%></span> </LEGEND>
                                  <div style="clear:both; display:block"><%=s0%></div>
                                  </FIELDSET>
                                  <%
									Else
									  Exit For
									End If  ' End jj-1 < Int(shRec)
								  Next      ' End 第几条记录
...
If Int(Page)-PSize<1 Then
  sPrev = "<span style='color:#CCCCCC'>上"&PSize&"个观点</span>"
Else
  nPrev = Int(Page)-PSize
  sPrev = "<a href='?ID="&ID&"&Page="&nPrev&"'>上"&PSize&"个观点</a>"
End If 

If Int(Page)+PSize>shRec Then
  sNext = "<span style='color:#CCCCCC'>下"&PSize&"个观点</span>"
Else
  nNext = Int(Page)+PSize
  sNext = "<a href='?ID="&ID&"&Page="&nNext&"'>下"&PSize&"个观点</a>"
End If 

%>
                      <tr>
                        <td align="left"><table width="100%" border="0" align="center" cellpadding="2" cellspacing="1">
                            <tr>
                              <td width="33%" align="center"><%=sPrev%></td>
                              <td width="33%" align="center">以上为:[<%=Page%>~<%=jMax%>个]观点 </td>
                              <td width="33%" align="center"><%=sNext%></td>
                            </tr>
                          </table></td>
                      </tr>
                    </form>

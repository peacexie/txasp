                          ...
                          <div style="padding-top:12px;">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
								...
								%>
                                  &nbsp;&nbsp;
                                  <input name="iRad<%=iKeyID%>" type="radio" id="iRad<%=iKeyID%>" value="1" style="vertical-align:middle;" onclick="javascript:return CheckItem(this)" >
                                  <%=jChar&". "&jItem%><br>
                                  <%
								 Next
								 End If
                ...
                <input name="goPage" type="hidden" id="goPage" value="<%=goPage%>"></td>
                              ...
                              <TR>
                                <TD colspan="2" align="left" nowrap><span style="float:right; padding-right:5%;">
                                  <input name="" type="button" value="查看结果" onclick="javascript:location.href='tview.asp?ID=<%=ID%>';"/></span>
                                  &nbsp;&nbsp;&nbsp;&nbsp;
                              ...
                              <%Else%>
                              <TR align=middle>
                                <TD height=30 colSpan=2 align="center" bgcolor="ffffDD"><span style="float:right; padding-right:5%;"><input name="" type="button" value="查看结果" onclick="javascript:location.href='tview.asp?ID=<%=ID%>';"/></span>注意：<%=fVNot%> </TD>
                              </TR>
                              <%End If%>
                        </TABLE></td>
                      </tr>
...
<script src="tvote.js" type="text/javascript"></script>
</BODY>
</HTML>

...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="E0E0E0">
  <tr align="center" bgcolor="E0E0E0">
    <td height="27" colspan="10" align="center" bgcolor="f8f8f8"><table width="100%" border="0" cellpadding="3" cellspacing="0">
        <tr align="center" bgcolor="#FFFFFF">
          <td width="30%" align="center" bgcolor="#FFFFFF"><strong>[问卷调查]管理<br>
</strong> <a href="../../vote/rlist.asp?TimID=All" target="_blank">演示</a> | <a href="ind_add.asp?TPU=<%=ModID%>">新增&gt;&gt;</a></td>
  ...
  <tr align="center" bgcolor="E0E0E0">
    ...
    <td align="center" nowrap><A href="vote_logs.asp" target="mainFrame">问卷记录</A></td>
...
InfSubj = Show_Text(InfSubj) 'Show_SetSubj(InfSubj,SetHot,SetSub)
    ...
    <tr bgcolor="<%=col%>">
      ...
      <td><a href="ind_edit.asp?ID=<%=KeyID%>" target="_blank"><%=InfSubj%></a>      </td>
      ...
      <td align="center" nowrap><a href="item_ind.asp?ID=<%=KeyID%>">调查项</a></td>
      <td align="center" nowrap><a href="ind_edit.asp?ID=<%=KeyID%>&PG=<%=Page%>&KW=<%=KW%>&TP=<%=TP%>">修改</a></td>
    <td align="center" nowrap>&nbsp;</td>
    </tr>
    <%
  rs.Movenext

...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="F0F0F0">
  <form name="fm01" id="fm01" action="info_add2.asp" enctype="multipart/form-data" method="post">
    <tr bgcolor="#FFFFFF">
      <td align="center" bgcolor="#FFFFFF"><p>&nbsp;</p></td>
      <td align="center" bgcolor="#FFFFFF"><strong>[投票项目]增加</strong></td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
oFCKeditor.Create() ; //Server.HTMLEncode(InfCont)
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td bgcolor="#FFFFFF"><input name="InfNum1" type="text" id="InfNum1" value="8" size="14" maxlength="2">
      ~ 
        <input name="InfNum2" type="text" id="InfNum2" value="12" size="14" maxlength="2"> 
        &nbsp;前者:&gt;=1; 后者:&lt;总数; 最多:24</td>
    </tr>
    <tr bgcolor="#FFFFFF">
      ...
      <td bgcolor="#FFFFFF"><select name="InfCard" id="InfCard" style="width:120px;">
        ...
        <select name="InfVNum" id="InfVNum" style="width:120px;">
          ...
          <option value='DNT1'>每IP共可投票1次</option>
          <option value='DXTN'>[无限制] 投票</option>
        </select></td>
    </tr>
    <tr bgcolor="#FFFFFF">

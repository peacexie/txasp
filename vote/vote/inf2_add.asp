...
sql = sql& ")"
 ...
 ReDir = "inf2_list.asp"
 If ReEnd="Y" Then ReDir="inf2_add.asp?ReEnd="&ReEnd&"&ReTyp="&InfType&""

 If send="send" And Trim(InfSubj)<>"" AND Trim(InfRem1)<>"" Then
...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="F0F0F0">
  <form name="fm01" id="fm01" action="?" method="post">
    ...
    <tr bgcolor="#FFFFFF">
      <td align="center" bgcolor="#FFFFFF">问卷须知<br></td>

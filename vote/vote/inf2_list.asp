...
</strong> <a href="../../vote/tlist.asp" target="_blank">演示</a> | <a href="inf2_add.asp?TPU=<%=ModID%>">新增&gt;&gt;</a></td>
...
InfSubj = Show_Text(InfSubj) 'Show_SetSubj(InfSubj,SetHot,SetSub)
    ...
    <tr bgcolor="<%=col%>">
      ...
      <td align="center" nowrap><a href="inf2_item.asp?ID=<%=KeyID%>">调查项</a></td>
      <td align="center" nowrap><a href="inf2_edit.asp?ID=<%=KeyID%>&PG=<%=Page%>&KW=<%=KW%>&TP=<%=TP%>">修改</a></td>
    <td align="center" nowrap>&nbsp;</td>
    </tr>
    <%
  rs.Movenext

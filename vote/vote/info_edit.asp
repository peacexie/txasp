...
<input name="KeyCode" type="text" id="KeyCode" value="<%=KeyCode%>" size="24" maxlength="24"></td>
    ...
    <tr bgcolor="#FFFFFF">
      <td align="center" bgcolor="#FFFFFF">投票须知<br>
        <input name="InfRem1" type="hidden" id="InfRem1" value=""></td>
      <td bgcolor="#FFFFFF">
...
oFCKeditor.Create() ; //Server.HTMLEncode(InfCont)
    ...
    <tr bgcolor="#FFFFFF">
      <td align="center" nowrap bgcolor="#FFFFFF">可选项目</td>
      <td bgcolor="#FFFFFF"><input name="InfNum1" type="text" id="InfNum1" value="<%=InfNum1%>" size="14" maxlength="2">
        ~
        <input name="InfNum2" type="text" id="InfNum2" value="<%=InfNum2%>" size="14" maxlength="2">
        &nbsp; 
        &nbsp;前者:&gt;=1; 后者:&lt;总数; 最多:24</td>
    </tr>
    <tr bgcolor="#FFFFFF">
      ...
      <td bgcolor="#FFFFFF"><select name="InfCard" id="InfCard" style="width:120px;">
        ...
        <select name="InfVNum" id="InfVNum" style="width:120px;">
          ...
          <option value='DNT1' <%If InfVNum="DNT1" Then Response.Write("selected")%>>每IP共可投票1次</option>
          <option value='DXTN' <%If InfVNum="DXTN" Then Response.Write("selected")%>>[无限制] 投票</option>
        </select></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td align="center" nowrap bgcolor="#FFFFFF">图片1</td>
      <td bgcolor="#FFFFFF"><IFRAME marginWidth=0 marginHeight=0
         src="../file/img_set.asp?TabID=VoteInfo&ID=<%=KeyID%>"

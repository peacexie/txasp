...
If xTab="SALE_ORDER" Then
  sqlOrd = " ORDER BY ORDER_ID DESC "
ElseIf xTab="SALE_GROUP_ORDER" Then
  sqlOrd = " ORDER BY SUBORDER_ID DESC "
Else

End If

  If xTab="SALE_ORDER" Then 
	xWhr = " AND TO_CHAR(CREATE_DATE, 'YYYY-MM-DD')>='2009-12-01' AND ORDER_NUMBER LIKE 'MTC%' "
  ElseIf xTab="SALE_GROUP_ORDER" Then
    xWhr = " AND TO_CHAR(CREATE_DATE, 'YYYY-MM-DD')>='2009-12-01' AND SUBORDER_NUMBER LIKE 'MTC%' " 
  Else

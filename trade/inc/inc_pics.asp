      ...
      <div class="ItemPic">
        <table width="168" border="0" align="center" cellpadding="2" cellspacing="1" style="border:1px #F0F0F0 solid;">
          <tr align="center" valign="middle">
            <td width="160" height="120"><a <%=InfLink%> target="_blank"><img src="<%=aImgs(1)%>" width="150" height="120" border="0" onload="javascript:setImgSize(this);" /></a></td>
          </tr>
          <tr align="left">
...
%>
  ...
  <tr>
    <td height="30"><%=RS_Page(rs,Page,"?send=pag&ModID="&MD&"&KeyWD="&KW&"&TypID="&TP&"&UsrID="&US&"",1)%></td>
  </tr>
  <%
end if
rs.close()

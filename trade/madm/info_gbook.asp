...
Elseif yAct="del_sel" then
  If Chk_URL3(Config_Path&"trade/madm/info_gbook.asp")="eUrl" Then
    Response.End()
  End If
  For iy = 1 To Request.Form("yID").Count
    iID = RequestSafe(Request.Form("yID").item(iy),3,96) 
...
<a href='?ModID=TraO124'>订购</a> | 
          ...
          <form name="fm01" method="post" action="?">
            <td align="right" nowrap><input name="send" type="hidden" id="send" value="sch">
              ...
              <select name="TP" style="width:120px; " id="TP">
                ...
                <option value="kUser">[User]</option>
  ...
  <tr align="center" bgcolor="E0E0E0">
    ...
    <td width="5%" align="center" nowrap>User</td>
    ...
    <td width="5%" height="27" align="center" nowrap>&nbsp;</td>
...
End If
    ...
    <tr bgcolor="<%=col%>">
      ...
      <td><a href="info_gbview.asp?KeyID=<%=KeyID%>" target="_blank"><%=InfSubj%></a> </td>
      <td align="center" nowrap><%=KeyUser%></td>

...
<%
MD=RequestS("ModID",3,48) :If MD="" Then MD="InfN124" 
MDName = "信息评论"
%>
<!--#include file="../pfile/pinc/remcode.asp"-->
      ...
      <td valign="top" style="BORDER:#E0E0E0 1px solid;"><table cellspacing="0" cellpadding="0" width="99%" border="0">
          <tr>
            <td height="500" colspan="4" align="left" valign="top" style="padding:5px;"><!--Item Start-->
              <!--#include file="../pfile/pinc/remark.asp"-->
            <!--Item End--></td>
          </tr>
        </table></td>
      <td width="8"></td>
      <td style="BORDER: #b6d9f7 1px solid;" valign="top" width="210" height="240"><!-- #include file="iside.asp" --></td>
    </tr>
</table>

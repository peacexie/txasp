...
function ChkPassStrength(sP){
	if(sP.length<5){
		DispPwdStrength(0,'memb_pws0');
		DispPwdStrength(1,'memb_pws0');
		DispPwdStrength(2,'memb_pws0');
		DispPwdStrength(3,'memb_pws0');
	}
	if(ClientSideStrongPassword(sP,gSimilarityMap,gDictionary)){
		DispPwdStrength(3,'memb_pws3');
	}else if(ClientSideMediumPassword(sP,gSimilarityMap,gDictionary)){
		DispPwdStrength(2,'memb_pws2');
	}else if(ClientSideWeakPassword(sP,gSimilarityMap,gDictionary)){
		DispPwdStrength(1,'memb_pws1');
	}else{
		DispPwdStrength(0,'memb_pws0');
	}
}
...
{
return (IsLongEnough(ClientSideWeakPassword.arguments[0], "5") ||

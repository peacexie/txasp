...
sql = sql& " WHERE KeyID='"&ID&"' "
  ...
  Response.Write js_Alert("修改成功！","Redir","ad_list.asp?TP="&TP&"") 
...
InfNameA = Split(InfName,"|")
InfContA = Split(InfCont,"|")
InfTypeA = Split(InfType,"|")
InfPathA = Split(InfPath,"|")
InfParaA = Split(InfPara,"|")

InfName=InfNameA(0) : InfNam2=InfNameA(1)
InfCont1=InfContA(0) : InfCont2=InfContA(1)
InfPara1=InfParaA(0) : InfPara2=InfParaA(1) : InfPara3=InfParaA(2) : InfPara4=InfParaA(3) : InfPara5=InfParaA(4)
InfType=InfTypeA(0) : InfTyp2=InfTypeA(1) : InfTyp3=InfTypeA(2)
InfPath1=InfPathA(0) : InfPath2=InfPathA(1)
...
<form action="?" method="post" name="fm01" id="fm01" style="margin:0px;">
  ...
  <table width="640" border="1" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" style="margin-top:-2px;">
    ...
    <tr>
      ...
      <td align="left" bgcolor="#EFEFEF"><input name="InfName" id="InfName" value="<%=InfName%>" size="45" maxlength="12" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;落款
    ...
    <tr>
      ...
      <td align="left" bgcolor="#EFEFEF"><select name="InfType" style="width:120px; " id="InfType">
        ...
        <select name="InfTyp3" id="InfTyp3" style="width:120px; ">
          ...
          <option value="Rnd_n12" <%If InfTyp3="Rnd_n12" Then Response.Write("selected")%>>淡黄1</option>
          <option value="Rnd_n13" <%If InfTyp3="Rnd_n13" Then Response.Write("selected")%>>淡黄2</option>
          <option value="Rnd_n14" <%If InfTyp3="Rnd_n14" Then Response.Write("selected")%>>深蓝2(QQ)</option>
        </select>
        <span class="FontRed">
    ...
    <tr>
      ...
      <td align="left"><textarea name="InfCont1" cols="60" rows="5" id="InfCont1"><%=InfCont1%></textarea>
        <br>
...
<br>
      <textarea name="InfCont2" cols="60" rows="5" id="InfCont2"><%=InfCont2%></textarea>
      <br>
(一般只用一个，仅对联填第二个) </td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="30" colspan="2" align="left" bgcolor="#EFEFEF"><span class="col00F">说明</span>： 请仔细阅读本说明，<span class="colF0F">如果觉得太麻烦，那请不要用这个功能！</span><br>
        ...
        ：每页只能放多1个； 
        <OPTION value="AdvLRQQ">QQ浮动</OPTION>
        ，全面支持QQ，MSN，Skype，阿里巴巴，Taobao旺旺等及时通讯，格式如80893510:Msn+peace@msn.com:Skype+peace0769:Ali+peaceAlibaba:Tao+peaceTaobao等。<br>

...
<table width="640" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="E0E0E0">
  <tr align="center" bgcolor="E0E0E0">
    <td height="27" colspan="7" align="center" bgcolor="f8f8f8"><table width="100%" border="0" cellpadding="3" cellspacing="0">
        <tr align="center" bgcolor="#FFFFFF">
          <td width="40%" align="center" bgcolor="#FFFFFF"><a href="ad_list.asp">浮动广告</a> - <a href="ad_pic.asp">图片广告</a> - <a href="ad_text.asp">文字广告</a><br>            <strong>文字广告管理</strong></td>
          ...
          <form name="fSearch" action="?">
            <td align="right" nowrap><input name="TP" type="text" id="TP" size="12" maxlength="24">
              ...
              <input type="submit" name="button" id="button" value="刷新" onClick="javascript:window.open('ad_tview.asp')"></td>
          </form>
        </tr>
      </table></td>
  </tr>
  ...
  <tr align="center" bgcolor="E0E0E0">
    ...
    <td align="center" nowrap bgcolor="E0E0E0">大小</td>
...
'InfType = rs_Val("","SELECT TypName FROM WebTyps WHERE TypID='"&InfType&"'")
  ...
  <form name="flist" method="post" action="?">
    <tr bgcolor="<%=col%>">
      ...
      <td align="center" nowrap><a href="ad_tedit.asp?ID=<%=KeyID%>&TP=<%=TP%>">设置</a></td>
      <td align="center" nowrap><a onClick="Del_YN('?ID=<%=KeyID%>&Page=<%=Page%>&yAct=del&TP=<%=TP%>','确认删除?')" href="#" >删除</a></td>
      <td align="center" nowrap><a href="ad_tview.asp?ID=<%=KeyID%>&Act=View" target="_blank">更新</a></td>
    </tr>
  </form>
  <%
  rs.Movenext
...
DefID = "Adt"&Rnd_ID("0",4) 
  ...
  <form name="ff" method="post" action="?">
    <tr bgcolor="#e8e8e8">
      ...
      <td colspan="2">
      <input name="InfPara1" type="text" id="InfPara1" value="120" size="4" maxlength="3">        
      <input name="InfPara2" type="text" id="InfPara2" value="60" size="4" maxlength="3"></td>

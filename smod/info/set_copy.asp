...
'dtpic-2011-76-9FQC.4VH0E,批量添加
'dtpic-2011-76-9FQC.4VH0B,
'dtpic-2010-6W-D32T.01DWR,人工添加
'dtpic-2010-6W-D2NC.01DUK,后3位SessionID
  p = inStr(xID,".") '后3位SessionID
  If inStr(xID,".01")>0 Then
    id = Left(xID,p-3)&Rnd_ID("KEY",2)&".0"&xModNO&Rnd_ID("KEY",5)
  Else
    id = Left(xID,p-3)&Rnd_ID("KEY",2)&".0"&xModNO&Rnd_ID("KEY",1)&Right(xID,2)&Rnd_ID("KEY",3)
  End If
  Dim p,e,id 
  If id=xID Then 

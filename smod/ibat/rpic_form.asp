...
<table width='100%' border='0' align='center' cellpadding='0' cellspacing='1'>
  <form name="iForm<%=Show_jsKey(id1)%>" id="iForm<%=Show_jsKey(id1)%>" action="rpic_up.asp?FrmFlag=<%=FrmFlag%>" enctype="multipart/form-data" method="post" target="_self">
    <tr>
    ...
    <tr>
      ...
      <td align='left' nowrap><input type='text' name='InfSubj<%=sys27_Rnd(1)%>' onChange="setCont(this)" id='InfSubj<%=sys27_Rnd(1)%>' style='width:285px'>
      <input name='SetTop' type='text' id='SetTop' style='width:50px' value="888" maxlength="4">
    ...
    <input name="IR" type="hidden" id="IR" value="<%=IR%>">

...
If PrmFlag="(Mem)" Then
  sqlK = sqlK&" And LogAUser='"&PrmUser&"' "
End If
...
<table width="620" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <td height="21" colspan="7" align="center" bgcolor="f8f8f8"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
        <form action="?" method="post" name="fsch9">
          ...
          <tr bgcolor="#FFFFFF">
            ...
            <td colspan="3" align="center" nowrap bgcolor="#FFFFFF">
            <%If PrmFlag="(Mem)" Then%>
            <a 
            href="?PrmFlag=(Mem)&ModID=userTemp">短信范本类别</a> | <a 
            href="?PrmFlag=(Mem)&ModID=userTels">电话薄类别</a>
            <%Else%>
            <a 
            href="?ModID=sysTemp">范本(系统)类别</a> | <a 
            href="?ModID=sysTels">电话薄(系统)类别</a> | <a 
            href="?ModID=userTels">范本(用户)类别</a> | <a 
            href="?ModID=userTels">电话薄(用户)类别</a>
            <%End If%>
            </td>
          </tr>
  ...
  <form name="ff<%=i%>" method="post" action="?">
    <tr bgcolor="<%=col%>">
      ...
      <td><input name="TypName" type="text" id="TypName" value="<%=TypName%>" size="18" maxlength="24"></td>
...
'Response.Write "<br>"&TypID&MinID
  ...
  <form name="ff" method="post" action="?">
    <tr bgcolor="#e8e8e8">
      ...
      <td><input name="TypName" type="text" id="TypName" size="18" maxlength="24"></td>

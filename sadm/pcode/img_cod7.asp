...
'End If
'If 1=0 Then
f(u,0)="+":f(u,1)="000000000000000001100000110000011000111111011111100011000001100000110000000000000000":f(u,2)=7:f(u,3)=12:u=u+1
f(u,0)="-":f(u,1)="000000000000000000000000000000000000111111011111100000000000000000000000000000000000":f(u,2)=7:f(u,3)=12:u=u+1
f(u,0)="*":f(u,1)="000000000000000100010001010000101000001000000100000101000100010010001000000000000000":f(u,2)=7:f(u,3)=12:u=u+1
f(u,0)="/":f(u,1)="000000000000000001100000110000000000111111011111100000000001100000110000000000000000":f(u,2)=7:f(u,3)=12:u=u+1
f(u,0)="=":f(u,1)="000000000000000000000011111101111110000000000000001111110111111000000000000000000000":f(u,2)=7:f(u,3)=12:u=u+1
f(u,0)="?":f(u,1)="000000000000000011100010001001000100000100000100000000000000000000100000010000000000":f(u,2)=7:f(u,3)=12:u=u+1
'End If
Class CDvCode7
	...
	Private Sub Class_Initialize
		Randomize
		mCodeTotal	= 6 'GetRnd(2,4)	'生成的验证码个数2
	...
	Public Sub CreateCode
		...
		Dim op :op=Mid("+-*/",Int((4)*Rnd+1),1)
		Dim n1 :n1=Int(89*Rnd+1)
		Dim n2 :n2=Int(9*Rnd+1)
		Dim n0 :n0=0
		Dim nt :nt=0
		Dim ns :ns=""
		'' + /////////////////////
		...
		ns = ns&"=?"
		'' End /////////////////////
		Dim nLen :nLen = Len(ns)
		Dim nArr(6)
		For i=0 To nLen-1
		    nArr(i) = 0
		Next
		For i=1 To nLen'mCodeTotal
			n			= inStr("0123456789+-*/=?",Mid(ns,i,1))
			nArr(i-1)   = n-1
		Next

...
' 2006-01-02
'''''''''''''''''''''''''''''''''''''''''''''
Public Noisy, nCount, Width, Height, Angle, Offset, Border
...
Const cCharSet = "123456789" '' ABCDEFGHIJKLMNOPQRSTUVWXYZ
...
Dim vExtent : vExtent = Width / nCount
...
Response.cachecontrol="no-cache"      '如果去掉此句则后退不刷新验证码
...
Set mCode = New Com_GifCode_Class
  ...
  If Config_PSess="" Then '记录入Session
	Session("ChkCode") = mCode.Create()
  Else
	Session(Config_PSess) = mCode.Create()
  End If
  mCode.Output()
Set mCode = Nothing
%>

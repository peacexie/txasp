...
sql = sql& ",ParNum =  " & RequestS("ParNum","N",0) &" " 
        ...
        <table width="640" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="e0e0e0">
          <tr align="center" bgcolor="f8f8f8">
            <td colspan="7"><table width="100%"  border="0" cellspacing="1" cellpadding="1">
                <tr>
                  <td width="20%" align="center" nowrap><strong>数字参数</strong><br>
...
ParNum = Show_Form(rs("ParNum"))

%>
          <form name="fmedit<%=i%>" method="post" action="para_int.asp">
		  <tr bgcolor="<%=col%>">
            <td align="right"><%=i%>&nbsp;</td>
            ...
            <td colspan="2"><input name='ParNum' type='text' value="<%=ParNum%>" size='12' maxlength='8' 
			onBlur="chkF_Int(document.fmedit<%=i%>.ParNum,'需要填写数字!')"></td>
			...
			onClick="Del_YN('para_int.asp?send=del&ParCode=<%=Show_jsStr(ParCode)%>','<%=Show_jsStr(ParName)%>\n确认删除 ?')"></td>
          </tr>
		  </form>
          <% 
rs.MoveNext 
...
%>
          ...
          <form name="fm01" method="post" action="para_int.asp">
            <tr bgcolor="f0f0f0">
              <td height="23" align="center">NO</td>
              <td ><input type='text' name='ParCode' size='12' maxlength='12'></td>
              <td><input type='text' name='ParName' size='18' maxlength='24'></td>
              <td><input name='ParNum' type='text' value="0" size='12' maxlength='8' 
			    onBlur="chkF_Int(document.fm01.ParNum,'需要填写数字!')" ></td>

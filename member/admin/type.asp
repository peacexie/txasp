...
If send = "ins" Then
  ...
  If exF2 = "YES" Then
    Msg = "新增失败！["&SysID&"]已经存在！"
  Else
    sql = "INSERT INTO [MemSyst] (SysID,[SysName],[SysType],SysTop,LogAddIP,LogAUser,LogATime)VALUES"
	sql =sql& "('"&SysID&"','"&SysName&"','"&SysType&"','"&SysTop&"','"&Get_CIP()&"','"&Session("UsrID")&"','"&Now()&"')"
...
ElseIf send = "edt" Then
    sql = " UPDATE [MemSyst] SET [SysName]='"&SysName&"',[SysType]='"&SysType&"',[SysDef]='"&RequestS("SysDef","c",24)&"',SysTop='"&SysTop&"'"
...
End If
	...
	sql =sql& " WHERE SysType='"&TPU&"' ORDER BY SysTop,SysID " 
...
%>
        ...
        <table width="640" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="E0E0E0">
          ...
          <tr align="center" bgcolor="E0E0E0">
            <td height="27" colspan="7" align="center" bgcolor="f8f8f8"><%if not rs.eof then
          ...
          <tr align="center" bgcolor="E0E0E0">
            ...
            <td width="150" align="center">等级-默认</td>
  ...
  for i = 1 to rs.PageSize
        ...
        SysDef = rs("SysDef")
		SysTop = rs("SysTop")
		gSet = "<a href='grade.asp?TPM="&SysID&"'>等级</a>"
	  ...
	  %>
          <form name="ff<%=i%>" method="post" action="?">
            <tr bgcolor="<%=col%>">
              ...
              <td align="center"><%=gSet%>
                <input name="SysType" type="hidden" id="SysType" value="<%=SysType%>" size="12" maxlength="12">
				  <select name="SysDef" id="SysDef" style="width:120; ">
                    <option value="" selected></option> 
                    <%=Get_rsOpt(conn,"SELECT SysID,SysName FROM MemSyst WHERE SysType='Grade' AND SysID LIKE 'g"&Mid(SysID,4,3)&"%'",SysDef)%>
                  </select>
		      </td>
              <td align="center"><input name="SysTop" type="text" id="SysTop" value="<%=SysTop%>" size="4" maxlength="1"></td>
          ...
          <form name="ff" method="post" action="?">
            <tr bgcolor="#e8e8e8">
              <td align="right"><input name="send" type="hidden" id="send" value="ins">
                ...
                新增 </td>
              <td bgcolor="#e8e8e8"><input name="SysID" type="text" id="SysID" value="Mod" size="12" maxlength="12"></td>
              <td><input name="SysName" type="text" id="SysName" size="24" maxlength="12"></td>
              <td><input name="SysType" type="hidden" id="SysType" value="<%=TPU%>" size="12" maxlength="12" readonly>              </td>
              <td><input name="SysTop" type="text" id="SysTop" value="6" size="4" maxlength="1"></td>
